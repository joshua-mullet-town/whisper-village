...
class SelectedTextService {
    ...
    private static let privatePasteboardType = NSPasteboard.PasteboardType("town.mullet.WhisperVillage.transient")

    static func fetchSelectedText() -> String? {
        // Don't check for selected text within Whisper Village itself
        guard let frontmostApp = NSWorkspace.shared.frontmostApplication,
              frontmostApp.bundleIdentifier != "town.mullet.WhisperVillage" else {
            return nil
        }
