            ...
            VStack(spacing: 16) {
                HStack(spacing: 16) {
                    ...
                    HStack(alignment: .lastTextBaseline, spacing: 8) { 
                        Text(licenseViewModel.licenseState == .licensed ? "Whisper Village Pro" : "Upgrade to Pro")
                ...
                Text(licenseViewModel.licenseState == .licensed ? 
                     "Thank you for supporting Whisper Village" :
        ...
        VStack(spacing: 32) {
            ...
            VStack(spacing: 24) {
                ...
                if licenseViewModel.activationsLimit > 0 {
                    ...
                    Text("You can use Whisper Village Pro on all your personal devices")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                }
            }
