        ...
        VStack {
            ...
            if case .trial(let daysRemaining) = licenseViewModel.licenseState {
                TrialMessageView(
                    ...
                    onAddLicenseKey: {
                        // Post notification to navigate to Whisper Village Pro tab
                        NotificationCenter.default.post(
                            name: .navigateToDestination,
                            object: nil,
                            userInfo: ["destination": "Whisper Village Pro"]
                        )
                    }
                )
                .padding()
                ...
                TrialMessageView(
                    message: "Your trial has expired. Upgrade to continue using Whisper Village",
                    type: .expired,
                    onAddLicenseKey: {
