...
struct OnboardingPermissionsView: View {
    ...
    private let permissions: [OnboardingPermission] = [
        ...
        OnboardingPermission(
            ...
            description: "Select the audio input device you want to use with Whisper Village.",
            icon: "headphones",
        ...
        OnboardingPermission(
            ...
            description: "Set up a keyboard shortcut to quickly access Whisper Village from anywhere.",
            icon: "keyboard",
