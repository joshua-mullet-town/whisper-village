...
extension WhisperState {
    ...
    func deleteParakeetModel() {
        ...
        do {
            // Model is stored directly in parakeetModelsDirectory (app support root)
            let parakeetModelDirectory = parakeetModelsDirectory.appendingPathComponent("parakeet-tdt-0.6b-v3-coreml")
